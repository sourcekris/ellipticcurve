// Package main implements some elliptic curve and polynomial algorithms useful for factorizing
// large composites.
package main
...
func main() {
	n, _ := new(fmp.Fmpz).SetString("1444329727510154393553799612747635457542181563961160832013134005088873165794135221", 10)
	...
	// E might be either type of curve.
